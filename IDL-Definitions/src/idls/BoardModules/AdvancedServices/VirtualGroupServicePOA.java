 ...
 implements BoardModules.AdvancedServices.VirtualGroupServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("heartbeat", new java.lang.Integer (3));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         BoardModules.StringListHolder membernames = new BoardModules.StringListHolder ();
         ...
         this.createBackupOfVirtualGroup (membernames, users, messages);
         out = $rh.createReply();
         BoardModules.StringListHelper.write (out, membernames.value);
         BoardModules.UserListHelper.write (out, users.value);
         BoardModules.MessageListHelper.write (out, messages.value);
         break;
       }

       case 3:  // BoardModules/AdvancedServices/VirtualGroupService/heartbeat
       {
         this.heartbeat ();
         out = $rh.createReply();
         break;
